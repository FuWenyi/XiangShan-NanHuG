...
//*# Library Name   : ts5n28hpcplvta8x128m2f (user specify : TS5N28HPCPLVTA8X128M2F)					*/
//*# Library Version: 130a												*/
//*# Generated Time : 2020/09/01, 00:14:30										*/
//*#*********************************************************************************************************************/
//*#															*/
//*# STATEMENT OF USE													*/
//*#															*/
...
`ifdef TSMC_INITIALIZE_MEM
parameter cdeFileInit  = "TS5N28HPCPLVTA8X128M2F_initial.cde";
`endif
`ifdef TSMC_INITIALIZE_FAULT
parameter cdeFileFault = "TS5N28HPCPLVTA8X128M2F_fault.cde";
`endif
...
specify
    ...
    specparam tCYC = 0.1873;
    specparam tCKH = 0.0843;
    specparam tCKL = 0.0843;
    ...
    specparam tDS = 0.0138;
    specparam tDH = 0.0903;
    specparam tCD = 0.1458;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.1458;
`else    
    specparam tHOLD = 0.1066;
`endif    
