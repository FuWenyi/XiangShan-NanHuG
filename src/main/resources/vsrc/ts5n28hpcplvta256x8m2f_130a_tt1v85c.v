...
//*# Library Name   : ts5n28hpcplvta256x8m2f (user specify : TS5N28HPCPLVTA256X8M2F)					*/
//*# Library Version: 130a												*/
//*# Generated Time : 2020/09/01, 00:03:41										*/
//*#*********************************************************************************************************************/
//*#															*/
//*# STATEMENT OF USE													*/
//*#															*/
...
`ifdef TSMC_INITIALIZE_MEM
parameter cdeFileInit  = "TS5N28HPCPLVTA256X8M2F_initial.cde";
`endif
`ifdef TSMC_INITIALIZE_FAULT
parameter cdeFileFault = "TS5N28HPCPLVTA256X8M2F_fault.cde";
`endif
...
specify
    ...
    specparam tCYC = 0.2914;
    specparam tCKH = 0.1311;
    specparam tCKL = 0.1311;
    specparam tCS = 0.0904;
    specparam tCH = 0.0272;
    specparam tWS = 0.0562;
    specparam tWH = 0.0588;
    specparam tAS = 0.0499;
    specparam tAH = 0.0570;
    specparam tDS = 0.0214;
    specparam tDH = 0.0725;
    specparam tCD = 0.1821;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.1821;
`else    
    specparam tHOLD = 0.0980;
`endif    
