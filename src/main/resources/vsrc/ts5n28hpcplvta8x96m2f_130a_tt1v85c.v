...
//*# Library Name   : ts5n28hpcplvta8x96m2f (user specify : TS5N28HPCPLVTA8X96M2F)					*/
//*# Library Version: 130a												*/
//*# Generated Time : 2020/09/01, 00:04:07										*/
//*#*********************************************************************************************************************/
//*#															*/
//*# STATEMENT OF USE													*/
//*#															*/
...
`ifdef TSMC_INITIALIZE_MEM
parameter cdeFileInit  = "TS5N28HPCPLVTA8X96M2F_initial.cde";
`endif
`ifdef TSMC_INITIALIZE_FAULT
parameter cdeFileFault = "TS5N28HPCPLVTA8X96M2F_fault.cde";
`endif
...
specify
    ...
    specparam tCYC = 0.1799;
    specparam tCKH = 0.0809;
    specparam tCKL = 0.0809;
    specparam tCS = 0.0762;
    specparam tCH = 0.0273;
    specparam tWS = 0.0597;
    specparam tWH = 0.0591;
    specparam tAS = 0.0356;
    specparam tAH = 0.0573;
    specparam tDS = 0.0158;
    specparam tDH = 0.0856;
    specparam tCD = 0.1376;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.1376;
`else    
    specparam tHOLD = 0.1028;
`endif    
