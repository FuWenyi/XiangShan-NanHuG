...
//*# Library Name   : ts5n28hpcplvta32x32m2f (user specify : TS5N28HPCPLVTA32X32M2F)					*/
//*# Library Version: 130a												*/
//*# Generated Time : 2020/09/01, 00:03:37										*/
//*#*********************************************************************************************************************/
//*#															*/
//*# STATEMENT OF USE													*/
//*#															*/
...
`ifdef TSMC_INITIALIZE_MEM
parameter cdeFileInit  = "TS5N28HPCPLVTA32X32M2F_initial.cde";
`endif
`ifdef TSMC_INITIALIZE_FAULT
parameter cdeFileFault = "TS5N28HPCPLVTA32X32M2F_fault.cde";
`endif
...
specify
    ...
    specparam tCYC = 0.1780;
    specparam tCKH = 0.0801;
    specparam tCKL = 0.0801;
    specparam tCS = 0.0774;
    specparam tCH = 0.0274;
    specparam tWS = 0.0594;
    specparam tWH = 0.0591;
    specparam tAS = 0.0369;
    specparam tAH = 0.0573;
    specparam tDS = 0.0198;
    specparam tDH = 0.0761;
    specparam tCD = 0.1306;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.1306;
`else    
    specparam tHOLD = 0.0958;
`endif    
