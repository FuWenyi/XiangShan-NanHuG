...
//*# Library Name   : ts5n28hpcplvta32x128m2f (user specify : TS5N28HPCPLVTA32X128M2F)					*/
//*# Library Version: 130a												*/
//*# Generated Time : 2020/09/01, 00:04:01										*/
//*#*********************************************************************************************************************/
//*#															*/
//*# STATEMENT OF USE													*/
//*#															*/
...
`ifdef TSMC_INITIALIZE_MEM
parameter cdeFileInit  = "TS5N28HPCPLVTA32X128M2F_initial.cde";
`endif
`ifdef TSMC_INITIALIZE_FAULT
parameter cdeFileFault = "TS5N28HPCPLVTA32X128M2F_fault.cde";
`endif
...
specify
    ...
    specparam tCYC = 0.1999;
    specparam tCKH = 0.0900;
    specparam tCKL = 0.0900;
    specparam tCS = 0.0775;
    specparam tCH = 0.0272;
    specparam tWS = 0.0593;
    specparam tWH = 0.0591;
    specparam tAS = 0.0370;
    specparam tAH = 0.0573;
    specparam tDS = 0.0133;
    specparam tDH = 0.0903;
    specparam tCD = 0.1557;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.1557;
`else    
    specparam tHOLD = 0.1070;
`endif    
