...
//*# Library Name   : ts5n28hpcplvta32x80m2f (user specify : TS5N28HPCPLVTA32X80M2F)					*/
//*# Library Version: 130a												*/
//*# Generated Time : 2020/09/01, 00:03:25										*/
//*#*********************************************************************************************************************/
//*#															*/
//*# STATEMENT OF USE													*/
//*#															*/
...
`ifdef TSMC_INITIALIZE_MEM
parameter cdeFileInit  = "TS5N28HPCPLVTA32X80M2F_initial.cde";
`endif
`ifdef TSMC_INITIALIZE_FAULT
parameter cdeFileFault = "TS5N28HPCPLVTA32X80M2F_fault.cde";
`endif
...
specify
    ...
    specparam tCYC = 0.1890;
    specparam tCKH = 0.0850;
    specparam tCKL = 0.0850;
    specparam tCS = 0.0775;
    specparam tCH = 0.0273;
    specparam tWS = 0.0593;
    specparam tWH = 0.0591;
    specparam tAS = 0.0369;
    specparam tAH = 0.0573;
    specparam tDS = 0.0166;
    specparam tDH = 0.0832;
    specparam tCD = 0.1431;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.1431;
`else    
    specparam tHOLD = 0.1014;
`endif    
