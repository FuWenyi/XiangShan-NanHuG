...
//*# Library Name   : ts5n28hpcplvta256x80m2f (user specify : TS5N28HPCPLVTA256X80M2F)					*/
//*# Library Version: 130a												*/
//*# Generated Time : 2020/09/01, 00:03:56										*/
//*#*********************************************************************************************************************/
//*#															*/
//*# STATEMENT OF USE													*/
//*#															*/
...
`ifdef TSMC_INITIALIZE_MEM
parameter cdeFileInit  = "TS5N28HPCPLVTA256X80M2F_initial.cde";
`endif
`ifdef TSMC_INITIALIZE_FAULT
parameter cdeFileFault = "TS5N28HPCPLVTA256X80M2F_fault.cde";
`endif
...
specify
    ...
    specparam tCYC = 0.3074;
    specparam tCKH = 0.1384;
    specparam tCKL = 0.1384;
    specparam tCS = 0.0901;
    specparam tCH = 0.0273;
    specparam tWS = 0.0563;
    specparam tWH = 0.0590;
    specparam tAS = 0.0497;
    specparam tAH = 0.0572;
    specparam tDS = 0.0139;
    specparam tDH = 0.0831;
    specparam tCD = 0.1995;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.1995;
`else    
    specparam tHOLD = 0.1058;
`endif    
