...
//*# Library Name   : ts5n28hpcplvta128x64m2f (user specify : TS5N28HPCPLVTA128X64M2F)					*/
//*# Library Version: 130a												*/
//*# Generated Time : 2020/09/01, 00:03:13										*/
//*#*********************************************************************************************************************/
//*#															*/
//*# STATEMENT OF USE													*/
//*#															*/
...
`ifdef TSMC_INITIALIZE_MEM
parameter cdeFileInit  = "TS5N28HPCPLVTA128X64M2F_initial.cde";
`endif
`ifdef TSMC_INITIALIZE_FAULT
parameter cdeFileFault = "TS5N28HPCPLVTA128X64M2F_fault.cde";
`endif
...
specify
    ...
    specparam tCYC = 0.2361;
    specparam tCKH = 0.1062;
    specparam tCKL = 0.1062;
    specparam tCS = 0.0829;
    specparam tCH = 0.0273;
    specparam tWS = 0.0580;
    specparam tWH = 0.0590;
    specparam tAS = 0.0424;
    specparam tAH = 0.0572;
    specparam tDS = 0.0168;
    specparam tDH = 0.0808;
    specparam tCD = 0.1663;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.1663;
`else    
    specparam tHOLD = 0.1015;
`endif    
