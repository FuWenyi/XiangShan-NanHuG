...
class TS5N28HPCPLVTA32X80M2F extends ExtModule with HasExtModuleResource {
  //  val io = IO(new Bundle {
...
class TS5N28HPCPLVTA256X80M2F extends ExtModule with HasExtModuleResource {
  ...
  val D =   IO(Input(UInt(80.W)))
  addResource("/vsrc/TS5N28HPCPLVTA256X80M2F.v")
}
...
class TS5N28HPCPLVTA8X512M2F extends Module {
  ...
  val sram = Seq.fill(4)(Module(new TS5N28HPCPLVTA8X128M2F()))
  sram.map(_.CLK := CLK)
...
class SRAMTemplate[T <: Data](
  ...
  println("Sram Width: %d, Set: %d, Way: %d, singlePort: %d", gen.getWidth.W, set, way, singlePort)
}
...
class tagSRAMTemplate[T <: Data](
  ...
  println("tagSram Width: %d, Set: %d, Way: %d, singlePort: %d", gen.getWidth.W, set, way, singlePort)
}

class l2SRAMTemplate[T <: Data](
  gen: T, set: Int, way: Int = 1, singlePort: Boolean = false,
  shouldReset: Boolean = false, extraReset: Boolean = false,
  holdRead: Boolean = false, bypassWrite: Boolean = false
) extends Module {
  ...
  val wordType = UInt(gen.getWidth.W)
  val sram = Seq.fill(way)(Module(new TS5N28HPCPLVTA8X512M2F()))
  val (resetState, resetSet) = (WireInit(false.B), WireInit(0.U))
  ...
  println("l2Sram Width: %d, Set: %d, Way: %d, singlePort: %d", gen.getWidth.W, set, way, singlePort)
}

class l3SRAMTemplate[T <: Data](
  gen: T, set: Int, way: Int = 1, singlePort: Boolean = false,
  shouldReset: Boolean = false, extraReset: Boolean = false,
  holdRead: Boolean = false, bypassWrite: Boolean = false
) extends Module {
  ...
  println("l3Sram Width: %d, Set: %d, Way: %d, singlePort: %d", gen.getWidth.W, set, way, singlePort)
}

class duplicated_dataSRAMTemplate[T <: Data](
  gen: T, set: Int, way: Int = 1, singlePort: Boolean = false,
  shouldReset: Boolean = false, extraReset: Boolean = false,
  holdRead: Boolean = false, bypassWrite: Boolean = false
) extends Module {
  ...
  println("duplicated_dataSram Width: %d, Set: %d, Way: %d, singlePort: %d", gen.getWidth.W, set, way, singlePort)
}
...
class eccSRAMTemplate[T <: Data](
  ...
  println("eccSram Width: %d, Set: %d, Way: %d, singlePort: %d", gen.getWidth.W, set, way, singlePort)
}
...
class ftbSRAMTemplate[T <: Data](
  ...
  val wordType = UInt(gen.getWidth.W)
  val sram = Seq.fill(way)(Module(new TS5N28HPCPLVTA256X80M2F()))
  val (resetState, resetSet) = (WireInit(false.B), WireInit(0.U))
  ...
  println("ftbSram Width: %d, Set: %d, Way: %d, singlePort: %d", gen.getWidth.W, set, way, singlePort)
}
...
class phtSRAMTemplate[T <: Data](
  ...
  val wordType = UInt(gen.getWidth.W)
  val sram = Seq.fill(way)(Module(new TS5N28HPCPLVTA32X80M2F()))
  val (resetState, resetSet) = (WireInit(false.B), WireInit(0.U))
  ...
  println("phtSram Width: %d, Set: %d, Way: %d, singlePort: %d", gen.getWidth.W, set, way, singlePort)
}

class ftqSRAMTemplate[T <: Data](
  gen: T, set: Int, way: Int = 1, singlePort: Boolean = false,
  shouldReset: Boolean = false, extraReset: Boolean = false,
  holdRead: Boolean = false, bypassWrite: Boolean = false
) extends Module {
  ...
  println("ftqSram Width: %d, Set: %d, Way: %d, singlePort: %d", gen.getWidth.W, set, way, singlePort)
}
...
class rrTableSRAMTemplate[T <: Data](
  ...
  println("rrTableSram Width: %d, Set: %d, Way: %d, singlePort: %d", gen.getWidth.W, set, way, singlePort)
}
...
class IcacheDataSRAMTemplate[T <: Data](
  ...
  println("IcacheDataSram Width: %d, Set: %d, Way: %d, singlePort: %d", gen.getWidth.W, set, way, singlePort)
}
...
class IcacheTagSRAMTemplate[T <: Data](
  ...
  println("IcacheTagSram Width: %d, Set: %d, Way: %d, singlePort: %d", gen.getWidth.W, set, way, singlePort)
}
...
class DcacheTagSRAMTemplate[T <: Data](
  ...
  println("DcacheTagSram Width: %d, Set: %d, Way: %d, singlePort: %d", gen.getWidth.W, set, way, singlePort)
}
...
class DCacheDataSRAMTemplate[T <: Data](
  ...
  println("DCacheDataSram Width: %d, Set: %d, Way: %d, singlePort: %d", gen.getWidth.W, set, way, singlePort)
}
...
class ITTAGESRAMTemplate[T <: Data](
  gen: T, set: Int, way: Int = 1, singlePort: Boolean = false,
  shouldReset: Boolean = false, extraReset: Boolean = false,
  holdRead: Boolean = false, bypassWrite: Boolean = false
) extends Module {
  ...
  println("ITTAGESram Width: %d, Set: %d, Way: %d, singlePort: %d", gen.getWidth.W, set, way, singlePort)
}

class ITTAGEFoldedSRAMTemplate[T <: Data](gen: T, set: Int, width: Int = 4, way: Int = 1,
  shouldReset: Boolean = false, extraReset: Boolean = false,
  holdRead: Boolean = false, singlePort: Boolean = false, bypassWrite: Boolean = false) extends Module {
  val io = IO(new Bundle {
    val r = Flipped(new SRAMReadBus(gen, set, way))
  ...
  val array = Module(new ITTAGESRAMTemplate(gen, set=nRows, way=width*way,
    shouldReset=shouldReset, extraReset=extraReset, holdRead=holdRead, singlePort=singlePort))
  if (array.extra_reset.isDefined) {
    array.extra_reset.get := extra_reset.get
  }
...
class usFoldedSRAMTemplate[T <: Data](gen: T, set: Int, width: Int = 4, way: Int = 1,
  shouldReset: Boolean = false, extraReset: Boolean = false,
  holdRead: Boolean = false, singlePort: Boolean = false, bypassWrite: Boolean = false) extends Module {
  val io = IO(new Bundle {
    val r = Flipped(new SRAMReadBus(gen, set, way))
  ...
  array.io.w.apply(wen, wdata, waddr, wmask)
  println("usSram Width: %d, Set: %d, Way: %d, singlePort: %d", gen.getWidth.W, set, way, singlePort)
}

class tbSRAMTemplate[T <: Data](
  gen: T, set: Int, way: Int = 1, singlePort: Boolean = false,
  shouldReset: Boolean = false, extraReset: Boolean = false,
  holdRead: Boolean = false, bypassWrite: Boolean = false
) extends Module {
...
class tbFoldedSRAMTemplate[T <: Data](gen: T, set: Int, width: Int = 4, way: Int = 1,
  shouldReset: Boolean = false, extraReset: Boolean = false,
  holdRead: Boolean = false, singlePort: Boolean = false, bypassWrite: Boolean = false) extends Module {
  val io = IO(new Bundle {
    val r = Flipped(new SRAMReadBus(gen, set, way))
  ...
  val array = Module(new tbSRAMTemplate(gen, set=nRows, way=width*way,
    shouldReset=shouldReset, extraReset=extraReset, holdRead=holdRead, singlePort=singlePort))
  if (array.extra_reset.isDefined) {
    array.extra_reset.get := extra_reset.get
  }
  ...
  array.io.w.apply(wen, wdata, waddr, wmask)
  println("tbSram Width: %d, Set: %d, Way: %d, singlePort: %d", gen.getWidth.W, set, way, singlePort)
